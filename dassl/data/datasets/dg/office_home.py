...
class OfficeHomeDG(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = osp.join(self.dataset_dir, 'OfficeHomeDataset_10072016')
        self.split_dir = osp.join(self.dataset_dir, 'office-home')
...
class PACS(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_dir = osp.join(self.dataset_dir, 'correct_txt_lists')

        if not osp.exists(self.dataset_dir):
            dst = osp.join(root, 'pacs.zip')
            self.download_data(self.data_url, dst, from_gdrive=False)
